...
public class AjoutRecForm extends BaseForm{
     Form current;
    public AjoutRecForm(Resources res)
    {
     ...
     btnAjouter.addActionListener((e) -> {
         try {
             if(sujet.getText()=="" || description.getText()=="" || etat.getText()=="")
             {
            ...
            Integer.valueOf(etat.getText())
            );
                 Message m = new Message("Vous avez ajouter une reclaamtion par SlowLife"  + " \n Détails de la reclamation: "
                    +"\n Sujet de reclamation : "+p.getSujet()
