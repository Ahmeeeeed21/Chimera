 ...
 * @author Yassine
 */
public class ListIngredientForm extends BaseForm {
    
       public ListIngredientForm(Form previous) {
        ...
        ArrayList<Ingredient> LI = ServiceIngredient.getInstance().getAllIngredients();
        ...
        for(Ingredient ing : LI)
        {
            ...
            text.addAll(lbNom,lbCalorie,btnmodifier);
            ...
            btnmodifier.addPointerPressedListener(e->{
                new EditIngredientForm(previous, ing).show();
            });
        }
