 ...
 * @author Wassim
 */
public class AjoutFeedForm extends BaseForm {
     Form current;
    public AjoutFeedForm(Resources res)
    {
        ...
        add(LayeredLayout.encloseIn(
                ...
                GridLayout.encloseIn(3, partage),
     ...
     btnAjouter.addActionListener((e) -> {
         try {
             if(type.getText()=="" || description.getText()=="" || sujet.getText()=="" ||  rate.getText()=="")
             {
                 ...
                 Feedback p = new Feedback(String.valueOf(sujet.getText()).toString(),
                         Integer.valueOf(rate.getText()),
                         String.valueOf(description.getText()).toString(),
               String.valueOf(type.getText()).toString()
                 );
                 
                 Message m = new Message("Vous avez ajouter un feedback par SlowLife"  + " \n Détails de feedback: "
                    +"\n Sujet de feedback : "+p.getSujet()
                 ...
                 FeedbackService.getInstance().ajoutFeedback(p);
                 iDialog.dispose();
